...
public class Ejercicio2 {
	...
	Scanner teclado = new Scanner (System.in);
		...
		if (anyosExperiencia >2 && cantidadProyectos>3 ) {
			...
			System.out.println("Lo sentimos pero no cumple\r\n"
					+ "nuestro perfil");
		}
		if (anyosExperiencia > 5 || cantidadProyectos > 5) {
			System.out.println("Salario a percibir: 30.000 euros anuales");
		}else {
			System.out.println("Salario a percibir: 25.000 euros anuales");
		}
